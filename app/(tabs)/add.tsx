...
export default function AddItemScreen() {
  ...
  const handleSaveExtractedItem = async () => {
    console.log('AddItemScreen: Saving extracted item');
    ...
    try {
      ...
      console.log('AddItemScreen: Item saved successfully');
      ...
      console.error('AddItemScreen: Error saving item:', error);
  ...
  const handlePickImage = async () => {
    console.log('AddItemScreen: Picking image');
    try {
      ...
      if (!result.canceled && result.assets[0]) {
        ...
        console.log('AddItemScreen: Image selected:', imageUri);
        ...
        try {
          ...
          console.log('AddItemScreen: Image uploaded:', data.url);
          setManualImage(data.url);
        } catch (error) {
          console.error('AddItemScreen: Error uploading image:', error);
      ...
      console.error('AddItemScreen: Error picking image:', error);
  ...
  const handleSaveManualItem = async () => {
    ...
    try {
      ...
      console.log('AddItemScreen: Manual item saved successfully');
      Alert.alert('Success', 'Item added to wishlist!', [
        {
          text: 'OK',
          onPress: () => {
      ...
      console.error('AddItemScreen: Error saving manual item:', error);
      Alert.alert('Error', 'Failed to save item. Please try again.');
    } finally {
      setSaving(false);
    }
